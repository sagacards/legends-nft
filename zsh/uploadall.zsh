...
# for file in art/preview-side-by-side/*; zsh zsh/upload.zsh $file "Side by Side Preview" "$(tags $file)" "A static preview displaying the card back and border" "image/webp" $network
...
for file in art/animated/compressed/*; zsh zsh/upload.zsh $file "Animated Preview" "$(tags $file)" "An animated preview displaying the rotating card" "image/webm" $network
